...
public class Commande_Interface extends JInternalFrame {
    ...
    static {
        try {
            commandes = Commande.get_all_commandes(MDIParent.db_connection);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }

    public Commande_Interface() throws SQLException {
        initComponents();
    }
    ...
    private void initComponents() throws SQLException {
        ...
        jButton2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    ajouter_commande(Integer.parseInt(jTextField3.getText()), jTextField2.getText(), (Integer) jSpinner1.getValue(),
                            formattedDate, Client.get_client_by_name(jComboBox1.getSelectedItem().toString(), Client.get_all_client(MDIParent.db_connection)));
        ...
        jButton8.setBackground(new java.awt.Color(158, 42, 43));
        jButton8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton8.setForeground(new java.awt.Color(255, 243, 176));
        ...
        jButton9.setBackground(new java.awt.Color(158, 42, 43));
        jButton9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton9.setForeground(new java.awt.Color(255, 243, 176));
        ...
        jButton10.setBackground(new java.awt.Color(158, 42, 43));
        jButton10.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton10.setForeground(new java.awt.Color(255, 243, 176));
        ...
        jButton11.setBackground(new java.awt.Color(158, 42, 43));
        jButton11.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton11.setForeground(new java.awt.Color(255, 243, 176));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        // TODO add your handling code here:
        chercher_commande(Integer.parseInt(jTextField3.getText()));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            modifier_commande(Integer.parseInt(jTextField3.getText()), jTextField2.getText(), (Integer) jSpinner1.getValue(),
                    formattedDate, Client.get_client_by_name(jComboBox1.getSelectedItem().toString(), Client.get_all_client(MDIParent.db_connection)));
        } catch (SQLException ex) {
            throw new RuntimeException(ex);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        // TODO add your handling code here:
        supprimer_commande(Integer.parseInt(jTextField3.getText()));
    }
    ...
    public static DefaultComboBoxModel populate_combobox() throws SQLException {
        ...
        for (Client c: Client.get_all_client(MDIParent.db_connection)){
            comboBoxModel.addElement(c.nom);
        }
    ...
    public static DefaultTableModel remplir_jtable() throws SQLException {
        model.setRowCount(0);
        for (Commande c : Commande.get_all_commandes(MDIParent.db_connection)){
            model.addRow(new Object[]{c.commande_id,c.commande_nom,c.quantite, c.date_commande, Client.get_client_by_id(c.getClient().id, Client.get_all_client(MDIParent.db_connection)).nom});
        }
        return model;
    }
    public static int find_commande_in_list(int id){
        for (int i=0;i<commandes.size();i++){
            if (commandes.get(i).commande_id == id) {
                return i;
            }
        }
        return -1;
    ...
    public void exporter_data(){
        ...
        if ( returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            org.example.Model.Commande.export_pdf(fileToSave, Login_Interface.user_logged_in.name +  " " + Login_Interface.user_logged_in.last_name ,  "Exportation des donnees | DATE " + formatter.format(date),commandes);
        }
    }

    public void supprimer_commande(int id) throws SQLException {
        if(find_commande_in_list(id)>-1){
            String query = "Delete from commande where commande_id="+id;
            int out = MDIParent.db_connection.execute_query_UD(query);
            if(out>0){
                commandes.remove(find_commande_in_list(id));
                jTable2.setModel(remplir_jtable());
                JOptionPane.showMessageDialog(null, "Commande supprimer!");
            }
            else {
                JOptionPane.showMessageDialog(null, "Aucune Commande n'a ete supprimer!");
            }
        }
        else{
    ...
    public void modifier_commande(int id_commande, String nom_commande, int quantite, String date_commande,Client client ) throws SQLException {
        if(find_commande_in_list(id_commande)!=-1){
            Commande commande_mod = new Commande(id_commande, nom_commande, quantite, date_commande, client);
            commandes.set(find_commande_in_list(id_commande),commande_mod);
            String query = "Update commande set commande_nom='"+commande_mod.commande_nom+"', quantite  = "+commande_mod.quantite+" , date_commande ='"+date_commande+"', client_id ='"+client.id+"' where commande_id="+commande_mod.commande_id;
            commandes=Commande.get_all_commandes(MDIParent.db_connection);
            MDIParent.db_connection.execute_query_UD(query);
            jTable2.setModel(remplir_jtable());
            JOptionPane.showMessageDialog(null, "Commande modifier!");
        }
        else{
            JOptionPane.showMessageDialog(null, "Cette id n'existe pas!");
        }
    ...
    public void ajouter_commande(int id_commande, String nom_commande, int quantite, String date_commande,Client client) throws SQLException {
        int count = MDIParent.db_connection.execute_query("Select count(*) as count from commande where commande_id=" + id_commande).getInt("count");
        if (count == 0 ) {
            if (!jTextField3.getText().equals("")) {
                Commande commande = new Commande(id_commande, nom_commande, quantite, date_commande, client);
                commandes.add(commande);
                String query = "Insert into commande values(" + commande.commande_id + ", '" + commande.commande_nom + "', " + commande.quantite + ", '" + commande.date_commande + "', '" + commande.getClient().id + "')";
                MDIParent.db_connection.execute_query_UD(query);
                jTable2.setModel(remplir_jtable());
    ...
    public static void chercher_commande(int id) throws SQLException {
        int output = find_commande_in_list(id);
        if (!search){
            search = true;
            jButton7.setText("X");
            if (output!=-1){
                ...
                model.setRowCount(0);
                model.addRow(new Object[]{commandes.get(output).commande_id,commandes.get(output).commande_nom,commandes.get(output).quantite, commandes.get(output).date_commande, commandes.get(output).getClient().getNom(), });
            }
            else{
                JOptionPane.showMessageDialog(null, "Cette id n'existe pas!");
            }
