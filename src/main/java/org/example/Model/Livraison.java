...
public class Livraison {
    ...
    public String getNumLvraison() {
        return NumLvraison;
    }

    public void setNumLvraison(String numLvraison) {
        NumLvraison = numLvraison;
    }

    public Livraison(String id, String numLvraison, Product produit) {
        this.id = id;
        NumLvraison = numLvraison;
...
//    int count = connection.execute_query("Select count(*) as number_of_products from livraison").getInt("number_of_livraisons");
//    ResultSet resultSet = connection.execute_query("Select * from livraison");
//
//    for (int i=0;i<count;i++){
//        livraisons.add(new Livraison(resultSet.getString("id_l"),
//                resultSet.getString("num"),
//                Product.get_produit_by_id(resultSet.getString("id_p"), connection))
//        );
//        resultSet.next();
//    }
//    return livraisons;
